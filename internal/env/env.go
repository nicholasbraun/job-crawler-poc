...
// domain-free: it knows how to look a variable up and fall back, and nothing
// about what any particular knob means. Defaults that carry domain meaning live
// with the package that owns them (e.g. postgres.DefaultURL,
